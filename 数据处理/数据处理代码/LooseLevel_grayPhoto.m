...
for i=1:n
  ...
  for j=1:n1
    str=strcat(str1,'\',nxx1(j).name);
      disp(str);
    [~,~,~,~,~,F1,G1,H1,I1,J1,K1,L1,M1,N1,O1,P1]=textread(str,'%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f',14000,'headerlines',3); %跳过3行开始读
...
%      AA(:,7)=1000*detrend(K1)/1.2;AA(:,8)=1000*detrend(L1)/1.2;AA(:,9)=1000*detrend(M1)/1.2;%9个点
        for j=1:140
            I=reshape(AA((1+(j-1)*100):(100*j))',1,10*10);
...
label=[l2 l1 l1 l1 l1 l1 l1;l1 l2 l1 l1 l1 l1 l1;l1 l1 l2 l1 l1 l1 l1;l1 l1 l1 l2 l1 l1 l1;;l1 l1 l1 l1 l2 l1 l1;l1 l1 l1 l1 l1 l2 l1;;l1 l1 l1 l1 l1 l1 l2];
save data data;
save label label;